...
class vLLMRollout(BaseRollout):
    ...
    def __init__(self, actor_module: nn.Module, config: DictConfig, tokenizer, model_hf_config, **kwargs):
        ...
        # Collect extra vLLM engine kwargs from config (e.g. enable_chunked_prefill, swap_space)
        extra_vllm_kwargs = {}
        for k in ('enable_chunked_prefill', 'swap_space', 'max_num_batched_tokens', 'max_num_seqs'):
            if k in config:
                extra_vllm_kwargs[k] = config.get(k)
